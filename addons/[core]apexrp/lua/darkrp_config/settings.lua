...
GM.Config.xpTimer = 600;
GM.Config.DeathTimer = 30;
GM.Config.DeathTimerVIP = 10;
GM.Config.Broadcast = Vector(0,0,0);
GM.Config.JailExit = Vector(-6815.271484, 9693.817383, -167.980179); 
GM.Config.JailExitAngle = Angle(0.000000, 0.000000, 0.000000);
GM.Config.JailPos = {
	Vector(-8353.670898, 11346.740234, -200.968750), -- City 17 SD 6964.227539 3355.946045 -207.968750 // City 8 Cellar -8353.670898, 11346.740234, -200.968750
};
...
GM.Config.dropmoneyondeath              = false -- do not enable this
...
GM.Config.PocketBlacklist = {
    ...
    ["hl2rp_rawration"] = true,
    ["hl2rp_rationoven"] = true,
    ["hl2rp_ration_maker"] = true,
    ["atm_machine"] = true,
    ["Keypad"] = true,
    ["gmod_wire_keypad"] = true,
    ["gmod_wire_button"] = true,
    ["gmod_wire_expression"] = true,
    ...
    ["rebel_radio"] = true,
    ["combine_mine"] = true,
    ["rg_production_table"] = true,
    ["rg_ingredientvendor"] = true,
    ["laundryendbasket"] = true,
    ["rg_weaponcraftingtable"] = true,
    ["rg_specatm"] = true,
    ["rg_productvendor"] = true,
    ["laundryfolding"] = true,
    ["ent_mannable_ar3"] = true,
    ["ent_mannable_airboatgun"] = true,
    ["ent_mannable_choppergun"] = true,
    ["ent_mannable_combinecannon"] = true,
    ["ent_mannable_combinesniper"] = true,
    ["ent_mannable_editable"] = true,
    ["ent_mannable_gauss"] = true,
    ["ent_mannable_gunship"] = true,
    ["ent_mannable_hmg"] = true,
    ["ent_mannable_fiery"] = true,
}
