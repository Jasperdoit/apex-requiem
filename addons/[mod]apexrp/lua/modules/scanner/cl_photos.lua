...
function scanner:takePicture()
    if ((self.lastPic or 0) < CurTime()) then
        self.lastPic = CurTime() + ( GAMEMODE.Config.scannerPictureDelay or 15 );
...
hook.Add("PostRender", "hl2rp: scanner", function()
    if (scanner.startPicture) then
...
concommand.Add("rg_photocache", function()
