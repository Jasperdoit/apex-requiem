...
SWEP.Base = "fl_base"
SWEP.PrintName = "Universal Union Standard-Issue Pulse Rifle"
SWEP.Spawnable = true
SWEP.AdminSpawnable = true
SWEP.Category = "Full-Life"
SWEP.ViewModel = "models/weapons/apexwep/c_irifle.mdl"
...
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/weapons/apexwep/c_irifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-16, 6.42, -3), angle = Angle(-16, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.HoldType = "ar2"
...
SWEP.Primary.ShootSound = Sound("Weapon_AR2.Single")
...
hook.Add("ScalePlayerDamage", "AR2ArmorScale", function(ply, hitgroup, dmg)
    ...
    if attacker:GetActiveWeapon():GetClass() != "fl_ar2" and ply:Armor() <= 0 then return end
    if (ply:Armor() > 0 ) then 
        dmg:SetDamage(dmg:GetDamage() * (math.Clamp((1 / ply:Armor()) * 10, 1, 2)));
    else
