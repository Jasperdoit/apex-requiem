...
SWEP.ViewModel = "models/weapons/apexwep/c_smg1.mdl"
SWEP.ViewModelFlip = false
SWEP.UseHands = true
SWEP.WorldModel = "models/weapons/w_smg1.mdl"
SWEP.ShowWorldModel = false
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/weapons/apexwep/c_smg1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-15, 7, -0.601), angle = Angle(-18, -0, 180), size = Vector(1, 0.949, 0.899), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.HoldType = "smg"
