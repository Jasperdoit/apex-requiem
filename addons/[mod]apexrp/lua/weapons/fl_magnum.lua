...
SWEP.ViewModel = "models/weapons/apexwep/c_357.mdl"
SWEP.ViewModelFlip = false
SWEP.UseHands = true
SWEP.WorldModel = "models/weapons/w_357.mdl"
SWEP.ShowWorldModel = false
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/weapons/apexwep/c_357.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-13.5, 5.432, -4.801), angle = Angle(-3.333, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
