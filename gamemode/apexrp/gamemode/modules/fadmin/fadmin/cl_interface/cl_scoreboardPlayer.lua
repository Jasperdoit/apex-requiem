...
FAdmin.ScoreBoard.Player:AddInformation("XP", function(ply) return ply:getXP() end)
FAdmin.ScoreBoard.Player:AddInformation("Division XP", function(ply) return (ply:getDivision() > 0 and ply:getDivisionXP()) or "/" end);
